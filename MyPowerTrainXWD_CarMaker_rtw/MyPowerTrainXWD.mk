...
MATSUPP_MATVER  = R2022a
MATSUPP_NUMVER  = 91200
...
MATLAB_ROOT	= $(subst \,/,/usr/local/MATLAB/R2022a)
ALT_MATLAB_ROOT	= $(subst \,/,/usr/local/MATLAB/R2022a)
MAKECMD         = "/opt/ipg/carmaker/linux64-11.1/bin/cmmake"
HOST            = ANY
BUILD           = yes
...
MODEL		= MyPowerTrainXWD
WRAPPER		= MyPowerTrainXWD_wrap
CLASS		= PowerTrainXWD
DESCRIPTION	= "MyPowerTrainXWD"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
INC_CFLAGS	+= -I$(subst \,/,"/home/dding/MATLAB-Drive/SXL4CM")
INC_CFLAGS	+= -I$(subst \,/,"/home/dding/MATLAB-Drive/SXL4CM/MyPowerTrainXWD_CarMaker_rtw")
